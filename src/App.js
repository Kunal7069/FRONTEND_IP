...
function App() {
  ...
  useEffect(() => {
    const fetchRegions = async () => {
      try {
        const response = await fetch("https://backend-ip-uswj.onrender.com/fetch_regions");
  ...
  const handleAllocateIp = async () => {
    ...
    try {
      const response = await fetch("https://backend-ip-uswj.onrender.com/allocate-ip", {
        method: "POST",
        headers: {
  ...
  const handleStopProcess = async () => {
    try {
      const response = await fetch("https://backend-ip-uswj.onrender.com/stop", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
